...
class VueStagesEmployeur extends StatefulWidget {
  const VueStagesEmployeur({super.key});

  @override
  _VueStagesEmployeurState createState() => _VueStagesEmployeurState();
}

class _VueStagesEmployeurState extends State<VueStagesEmployeur> {
  @override
    ...
    if (user != null) {
      ...
      return Scaffold(
        ...
        body: FutureBuilder<QuerySnapshot>(
          future: vueStagesEmployeur(userId), // Fetch stages for the current employer
